...
root = r'C:\Saeid\Prj100\SA_2\snowModelUZH\case3_hoch-ybrig_v3_3'
...
if __name__ == '__main__':
    ...
    results = perform_experiments(model, 150, 50)
...
save_results(results, r'C:\Saeid\Prj100\SA_2\snowModelUZH\case3_hoch-ybrig_v3_3\CHrandomness_7\7500_runs.tar.gz')
